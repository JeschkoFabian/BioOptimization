...
/**
 * Class representing problem ZDT4 2-12-2015. Modified to be used in the
 * Bio-inspired optimization lecture.
 */
public class ZDT4 implements ZDT {
	...
	public double evalG(double[] solution) {
		double g = 0.0;
		for (int var = 1; var < numberOfVariables_; var++)
			g += Math.pow(solution[var], 2.0) + -10.0 * Math.cos(4.0 * Math.PI * solution[var]);
